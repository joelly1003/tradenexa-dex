      ...
      <div className="flex-1 flex items-center gap-3 sm:gap-4 justify-end relative">
        ...
        <div className="hidden sm:flex items-center gap-1 relative" ref={settingsRef}>
          <button 
            ...
            className={`p-2 rounded-lg transition-colors ${isSettingsOpen ? 'bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white' : 'text-zinc-500 hover:text-black dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-900'}`}
          >
