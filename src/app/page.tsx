...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col gap-10 max-w-7xl mx-auto py-4 px-4 sm:px-6">
      ...
      {/* Top Section: Hero */}
      <div className="flex flex-col items-center text-center max-w-3xl mx-auto min-h-[calc(100vh-100px)] pt-32 pb-8">
        
        {/* Main Content Group (Flex-1 allows it to push the bottom row down) */}
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800/50 w-full">
